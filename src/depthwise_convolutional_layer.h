...
//void binarize_weights2(float *weights, int c, int size, char *binary, float *scales);
...
image get_depthwise_convolutional_image(depthwise_convolutional_layer layer);
image get_depthwise_convolutional_delta(depthwise_convolutional_layer layer);
image get_depthwise_convolutional_weight(depthwise_convolutional_layer layer, int i);
