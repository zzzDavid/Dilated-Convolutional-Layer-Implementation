...
void update_depthwise_convolutional_layer_gpu(layer l, update_args a)
{
    ...
    if(a.adam){
        ...
        //axpy_gpu(l.c, learning_rate/batch, l.bias_updates_gpu, 1, l.biases_gpu, 1);//////////////
        //scal_gpu(l.c, momentum, l.bias_updates_gpu, 1);////////////

        if(l.scales_gpu){
            axpy_gpu(l.c, learning_rate/batch, l.scale_updates_gpu, 1, l.scales_gpu, 1);///////////
            scal_gpu(l.c, momentum, l.scale_updates_gpu, 1);///////////////
        }
    }
}
