...
/**
 * Convert a YUYV 422 packed image into RGB float -- channel wise.
 */
...
//////////////////////////////////////////////////////////////////////////////////
/// @name UYUV 4:2:2 packed (UYVY & YUYV) to NV12
/// @ingroup util
//////////////////////////////////////////////////////////////////////////////////
...
/**
 * Convert a UYVY 422 packed image into a uint8 NV12.
 */
...
/**
 * Convert a YUYV 422 packed image into a uint8 NV12.
 */
...
/**
 * Convert a UYVY 422 packed image into a unsigned char nv12.
 */
cudaError_t cudaUYVYToYV12( unsigned char* input, unsigned char* output, size_t width, size_t height );

/**
 * Convert a YUYV 422 packed image into a unsigned char nv12.
 */
