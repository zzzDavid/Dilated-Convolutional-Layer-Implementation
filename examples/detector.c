...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
    ...
    while(1){
        ...
        //~ image sized = make_empty_image(net.w, net.h, c);
        //~ float *sized_gpu =  cuda_make_array(sized.data, sized.h * sized.w * sized.c);
        
        //~ time=what_time_is_it_now();
//#ifdef GPU
        //~ cuda_set_device(net.gpu_index);
        //~ printf("1-1\n");
        //~ float *im_gpu =  cuda_make_array(im.data, im.h * im.w * im.c);
	//~ letterbox_image_into_gpu(im_gpu, im.w, im.h, net.input_gpu, net.w, net.h);
	//~ printf("1-2\n");
        //cuda_pull_array(net.input_gpu, net.input, net.inputs*net.batch);
	//image sized = make_image_from_rgb(net.w, net.h, 3, net.input);
	//save_image(sized, "letterbox");
//#else
        image sized = letterbox_image(im, net.w, net.h);
//#endif
        //~ printf("letterbox_image in %f seconds.\n", what_time_is_it_now()-time);
